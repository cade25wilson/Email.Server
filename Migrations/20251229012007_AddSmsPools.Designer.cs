...
namespace Email.Server.Migrations
{
    ...
    [Migration("20251229012007_AddSmsPools")]
    partial class AddSmsPools
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Email.Server.Models.RegionsCatalog", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Region = "us-east-1",
                            CreatedAtUtc = new DateTime(2025, 12, 29, 1, 20, 5, 842, DateTimeKind.Utc).AddTicks(5722),
                        ...
                        {
                            Region = "us-west-2",
                            CreatedAtUtc = new DateTime(2025, 12, 29, 1, 20, 5, 842, DateTimeKind.Utc).AddTicks(7838),
                        ...
                        {
                            Region = "eu-west-1",
                            CreatedAtUtc = new DateTime(2025, 12, 29, 1, 20, 5, 842, DateTimeKind.Utc).AddTicks(7840),
                            DefaultForNewTenants = false,
                        ...
                        new
                        {
                            ...
                            CreatedAtUtc = new DateTime(2025, 12, 29, 1, 20, 5, 842, DateTimeKind.Utc).AddTicks(7842),
                            DefaultForNewTenants = false,
            ...
            modelBuilder.Entity("Email.Server.Models.SmsPhoneNumbers", b =>
                {
                    ...
                    b.HasIndex("PoolId")
                        .HasDatabaseName("IX_SmsPhoneNumbers_PoolId");
            ...
            modelBuilder.Entity("Email.Server.Models.SmsPools", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<string>("AwsPoolArn")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");

                    b.Property<string>("AwsPoolId")
                        .HasMaxLength(64)
                    ...
                    b.HasIndex("AwsPoolId")
                        .HasDatabaseName("IX_SmsPools_AwsPoolId");

                    b.HasIndex("TenantId")
                        .IsUnique()
                        .HasDatabaseName("UQ_SmsPools_Tenant");

                    b.ToTable("SmsPools", (string)null);
                });
            ...
            modelBuilder.Entity("Email.Server.Models.SmsPhoneNumbers", b =>
                {
                    b.HasOne("Email.Server.Models.SmsPools", "Pool")
